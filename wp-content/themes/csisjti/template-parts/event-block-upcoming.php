	...
	<div class="event-block">
		...
		<div class="event-block__date">
			<?php $date = split_date(get_field('date_of_event')); ?>
				 ...
				 <p class="event-block__day"><?php echo $date[2] ?></p>
				 <p class="event-block__year"><?php echo $date[0] ?></p>
			<?php endif; ?>
		</div>

		<?php if( get_field('time') ): ?>
			<p class="event-block__time"><?php the_field('time'); ?></p>
		<?php endif; ?>

		<?php if( get_field('location') ): ?>
			<?php $location = get_field('location', false, false); ?>
				<p class="event-block__location"><?php echo $location; ?></p>
		<?php endif; ?>
