...
<header class="entry-header<?php echo esc_attr( $entry_header_classes ); ?>">
	...
	?>
		<p class="entry-header__icon"><button id="classification-btn" data-a11y-dialog-show="my-accessible-dialog" ><?php echo csisjti_get_svg('info'); ?></button>Classifications</p>
